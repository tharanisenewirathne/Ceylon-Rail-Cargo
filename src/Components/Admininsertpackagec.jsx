...
const Admininsertpackagec = React.forwardRef((props, ref) => {
  ...
  const generateOrderID = () => {
    // Generate a random number as a unique ID
  ...
  const [user,setUser] = useState(
    {
      sfirstName: '', slastName: '', snic: '', sphoneNo: '', 
        saddress: '',fromValue: '',rfirstName: '', rlastName: '', rnic: '', rphoneNo: '', raddress: '' , toValue: '', status: 'shipping',date
    }
  )
  ...
  const handleClick = (e) => {
    e.preventDefault();
      const{sfirstName, slastName, snic, sphoneNo, 
        saddress,from,rfirstName, rlastName, rnic, rphoneNo, raddress,toValue } = user;
        const newOrderID = generateOrderID();
        setOrderID(newOrderID)


    /*console.log('Form submitted:', { sfirstName, slastName, snic, sphoneNo, 
      saddress,rfirstName, rlastName, rnic, rphoneNo, raddress });*/
    const fromSelect = document.getElementsByName('fromValue')[0];
    ...
    if (fromValue === 8000) {
      ...
      const toSelect = document.getElementsByName('toValue')[0];
      ...
      if(lastThreeNumbers >=200 && weight>=50 ){
        cost = weightValue * 2.4;
  
      }else if (lastThreeNumbers >= 100 && lastThreeNumbers < 200 && weight>=50 ) {
      
      cost = weightValue * 1.7;
      }else{
    ...
    const options = {
      ...
      body: JSON.stringify({
        sfirstName, slastName, snic, sphoneNo, 
      saddress,fromValue,rfirstName, rlastName, rnic, rphoneNo, raddress,toValue,status,date, orderID: newOrderID
      })
    }
    fetch('https://project1-be0da-default-rtdb.firebaseio.com/InsertPakageData.json', options)
    .then(response => {
      if (response.ok) {
  ...
  return (
    <div ref={ref} >
      <div className='flex flex-col-2 bg-[#121212] text-gray-200' style={{ display: 'flex', paddingLeft: '18%',paddingTop:'3%'}}>
      
          <div style={{width:'50%',marginLeft:'3%'}}>
          <h1 className=" text-base font-bold "style={{ fontFamily: 'Comfortaa' }}>Senders Details</h1>
          <br/><br/>

          
          <div style={{flexDirection:'row',display:'flex'}}>
            <div style={{width:'45%'}}>
            <label htmlFor="sfirstName">First Name:</label><br/>
          <input
            type="text"
            name="sfirstName"
            value={user.sfirstName}
            required onChange={data}
            //onChange={(e) => setSFirstName(e.target.value)}
            placeholder="Enter First Name"
            className="border w-[190px] bg-[#343434] border-[#343434]
             placeholder-gray-200 h-[40px] p-2 rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}
          />
            </div>
            <div style={{width:'45%'}}>
            <label htmlFor="slastName">Last Name:</label><br/>
          <input
            type="text"
            name="slastName"
            value={user.slastName}
            required onChange={data}
            //onChange={(e) => setSLastName(e.target.value)}
            placeholder="Enter Last Name"
            className="border w-[190px] bg-[#343434] border-[#343434]
             placeholder-gray-200 p-2  rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}  
          />
            </div>
        </div>
        ...
        <div style={{flexDirection:'row',display:'flex'}}>
            <div style={{width:'45%'}}>
            <label htmlFor="snic">NIC:</label><br/>
          <input
            type="text"
            name="snic"
            value={user.snic}
            ...
            placeholder="Enter Sender's NIC"
            className="border w-[190px] bg-[#343434] border-[#343434]
             placeholder-gray-200 h-[40px] p-2 rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}
          />
            ...
            <div style={{width:'50%'}}>
            <label htmlFor="sphoneNo">Phone No:</label><br/>
          <input
            type="tel"
            name="sphoneNo"
            value={user.sphoneNo}
        ...
        <br/>
          ...
          <div>
          <label htmlFor="saddress">Address:</label><br/>
          <input
            type="text"
            name="saddress"
            value={user.saddress}
            ...
            className="border w-[420px] bg-[#343434] border-[#343434]
            placeholder-gray-200 p-2  rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}
          />
          </div>
          ...
          <label htmlFor="senders_station">Senders Station:</label><br/>
          <select
          name="fromValue"
          value={user.fromValue}
          required onChange={data}
          //onChange={(e) => setFromValue(e.target.value)}
          className="border w-[220px] bg-[#343434] border-[#343434] p-2  rounded-md shadow-xl"
          style={{ borderRadius: '8px'  }}
        >
        ...
        <div style={{width:'50%',marginLeft:'3%'}}>
        <h1 className=" text-base font-bold "style={{ fontFamily: 'Comfortaa' }}>Receivers Details</h1>
          <br/><br/>
          <div style={{flexDirection:'row',display:'flex'}}>
            <div style={{width:'45%'}}>
            <label htmlFor="rfirstName">First Name:</label><br/>
          <input
            type="text"
            name="rfirstName"
            value={user.rfirstName}
            required onChange={data}
          ...
          />
            ...
            <div style={{width:'45%'}}>
            <label htmlFor="rlastName">Last Name:</label><br/>
          <input
            type="text"
            name="rlastName"
            value={user.rlastName}
            required onChange={data}
        ...
        <div style={{flexDirection:'row',display:'flex'}}>
            <div style={{width:'45%'}}>
            <label htmlFor="rnic">NIC:</label><br/>
            <input
            type="text"
            name="rnic"
            value={user.rnic}
            required onChange={data}
            //onChange={(e) => setRNIC(e.target.value)}
          ...
          />
            ...
            <div style={{width:'50%'}}>
            <label htmlFor="rphoneNo">Phone No:</label><br/>
            <input
            type="tel"
            name="rphoneNo"
            value={user.rphoneNo}
            required onChange={data}
            //onChange={(e) => setRPhoneNo(e.target.value)}
            placeholder="Enter Phone Number"
            className="border w-[190px] bg-[#343434] border-[#343434]
            placeholder-gray-200 p-2  rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}  
        ...
        <br/>
          ...
          <div>
          <label htmlFor="raddress">Address:</label><br/>
          <input
            type="text"
            name="raddress"
            value={user.raddress}
          ...
          <div>
          <label htmlFor="Receiver_station">Receiver's Station:</label><br/>
          <select
          name="toValue"
          value={user.toValue}
          required onChange={data}
      ...
      <div className='flex bg-[#121212] text-white' style={{ display: 'flex', paddingLeft: '18%', paddingTop: '10%', paddingBottom: '6%'}}>
        <div style={{width:'90%',marginLeft:'3%'}}>
          <h1 className=" text-base font-bold "style={{ fontFamily: 'Comfortaa' }}>Package Details</h1>
          <br/>

          <div style={{flexDirection:'row',display:'flex'}}>

            <div style={{width:'50%',marginRight:'10%'}}>
            <label htmlFor="item_category">Item Category:</label><br/>
            <select
            name="item"
            value={user.item}
            required onChange={data}
            //onChange={(e) => setItem(e.target.value)}
            className="border w-[230px]  bg-[#343434] border-[#343434] p-2  rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}
            >
            ...
            className="border w-[230px] bg-[#343434] border-[#343434]
            placeholder-gray-200 p-2  rounded-md shadow-xl"
            style={{ borderRadius: '8px'  }}  
            />
            </div>
          ...
          <div style={{marginLeft:'78%'}}>
            <button
            type="submit" 
            className="rounded-md px-4 py-2 w-[25vh] h-[7vh] bg-[#53161d] text-white font-semibold 
...
export default Admininsertpackagec